...
TELEGRAM_KEY = os.environ.get('FEEL_TELEGRAM_KEY')
contract = "0x12fff190563b1d1ba73c5bf9b665895978e20b9a"
name = "FEEL"
pair_contract = "0x189ce88a8b777ae8cb6e6ec8ceef051959192aa4"
ticker = 'FEEL'
...
commands = """
chart - Display price chart of the token.
price - Get current price of the token.
